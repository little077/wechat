...
__DEFINE__(1645234736565, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1645234736566,"./event-store":1645234736567}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645234736566, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1645234736567, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1645234736566,"./utils":1645234736568}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1645234736568, function(require, module, exports) {
...
return __REQUIRE__(1645234736565);
})()
